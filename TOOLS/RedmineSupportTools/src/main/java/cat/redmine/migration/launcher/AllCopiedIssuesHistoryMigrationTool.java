...
public class AllCopiedIssuesHistoryMigrationTool {
	...
	*/
	public static void main(String [] args){
		...
		try{
			...
			// 복사 대상 저널 목록을 추출한다.
			List journalList = selectJournals(conn, sourceProjectId, targetProjectId);
	...
	* @throws SQLException
	*/
	private static List selectJournals(Connection conn, int sourceProjectId, int targetProjectId)  throws SQLException{
		List result = null;
